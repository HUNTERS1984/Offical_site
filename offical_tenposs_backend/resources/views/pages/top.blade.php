...
@section('css')
	{{Html::style(env('PATH_FRONTEND').'/css/top.css')}}
@stop
	...
	<div class="middle">
		<div class="section video-section">
			<div class="container">
				<div class="row">
					<a href="#">
						<img src="{{env('PATH_FRONTEND')}}/img/top/ic-video.png" height="56" width="59" alt="">
				...
				<div class="row">
					<div class="col-md-9 col-md-offset-3">
						<div class="wrap-search">
							<h2 class="title-search"><img src="{{env('PATH_FRONTEND')}}/img/top/small-img.png" alt=""> でお店のファンやリピーターを増やしましょう。</h2>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-4">
						<div class="each-function">
							<img src="{{env('PATH_FRONTEND')}}/img/top/function01.png" class="img-responsive" alt="">
					...
					<div class="col-md-4">
						<div class="each-function">
							<img src="{{env('PATH_FRONTEND')}}/img/top/function02.png" class="img-responsive" alt="">
					...
					<div class="col-md-4">
						<div class="each-function">
							<img src="{{env('PATH_FRONTEND')}}/img/top/function03.png" class="img-responsive" alt="">
				...
				<div class="row">
					<div class="wrap-button text-center">
						<a href="#" class="btn-me btn-xanhduong">詳しい機能はこちら</a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="section img-section bg-blue">
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-12">
						<img src="{{env('PATH_FRONTEND')}}/img/top/top-06.png" class="img-responsive" alt="">
					</div>
				</div>
			</div>
		</div>
				...
				<div class="carousel-inner" role="listbox">
					<div class="item active">
						<div class="container">
							<div class="row">
								<div class="col-md-3">
									<img src="{{env('PATH_FRONTEND')}}/img/top/small-phone.png" class="img-responsive hidden-sm hidden-xs" alt="">
								</div>
								<div class="col-md-9">
