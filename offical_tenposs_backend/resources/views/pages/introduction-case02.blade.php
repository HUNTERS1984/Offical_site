				...
				<div class="page-banner bg-blue" id="introcase02">
					<div class="is-table-cell">
						...
						<div class="left-banner">
							<img src="{{env('PATH_FRONTEND')}}/img/introduction/introcase02-02.png" class="img-responsive" alt="">
						</div>
					...
					<div class="container">
						<div class="row">
							<div class="col-md-10 col-md-offset-1">
								<div class="box-intro-big">
									<img src="{{env('PATH_FRONTEND')}}/img/introduction/introductioncase-banner-02.png" class="img-responsive" alt="">
								...
								<div class="box-intro-small clearfix">
									<div class="left">
										<img src="{{env('PATH_FRONTEND')}}/img/introduction/tenposs-introductioncase-02-01.png" class="img-responsive visible-sm visible-xs" alt="">
									...
									<div class="right hidden-xs hidden-sm">
										<img src="{{env('PATH_FRONTEND')}}/img/introduction/tenposs-introductioncase-02-01.png" class="img-responsive" alt="">
									</div>
						...
						<div class="row">
							<div class="col-sm-12 text-center">
								<img src="{{env('PATH_FRONTEND')}}/img/introduction/introductioncase-arrow.png" class="img-responsive arrow"  alt="">
							</div>
						</div>
						<div class="row">
							<div class="col-md-6">
								<img src="{{env('PATH_FRONTEND')}}/img/introduction/tenposs-introductioncase-02-02.png" class="img-responsive ic-block" alt="">
							</div>
							<div class="col-md-6">
								<div class="wrap-img-right">
									<div class="block-img-right">
										<img src="{{env('PATH_FRONTEND')}}/img/introduction/tenposs-introductioncase-02-03.png" alt="">
										<img src="{{env('PATH_FRONTEND')}}/img/introduction/tenposs-introductioncase-02-04.png" alt="">
									</div>
