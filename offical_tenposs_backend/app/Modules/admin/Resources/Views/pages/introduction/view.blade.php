...
<section class="content">
	<div class="box">
		{{Form::model($data,array('route'=>array('admin.introduction.update',$data->id),'method'=>'PUT' ,'class'=>'formAdmin form-horizontal','files'=>true))}}
			...
			<div class="form-margin">
				<label for="name">Introduction Category</label>
				{{Form::select('intro_type_id',$list,$data->intro_type_id,['class'=>'form-control'])}}
			</div>
			<div class="form-margin">
