...
class IntergrationController extends Controller
{
    ...
    public function index(){
    	...
    	// dd($data);
    	return view('admin::pages.intergration.index',compact('data'));
    }

    public function create()
    {
    	return view('admin::pages.intergration.create');
    }
    ...
    public function store(ImageRequest $imgrequest)
    {
    	...
    	return redirect()->route('admin.intergration.index');
    ...
    public function edit($id)
    {
    	...
    	return view('admin::pages.intergration.view',compact('data'));
    }
