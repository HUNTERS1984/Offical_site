...
use App\Models\Startguide;
use App\Modules\admin\Http\Requests\ImageRequest;
use Notification;

class StartguideController extends Controller
{
    protected $entity;
	protected $request;

	public function __construct(Startguide $entity, Request $request){
		$this->entity = $entity;
    ...
    public function index(){
    	...
    	// dd($data);
    	return view('admin::pages.startguide.index',compact('data'));
    }

    public function create()
    {
    	return view('admin::pages.startguide.create');
    }
    ...
    public function store(ImageRequest $imgrequest)
    {
    	...
    	return redirect()->route('admin.startguide.index');
    ...
    public function edit($id)
    {
    	...
    	return view('admin::pages.startguide.view',compact('data'));
    }
